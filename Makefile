...
e2t-smoke-e2ap101:
	 STORE_CONSENSUS_PERSISTENCE_STORAGE_CLASS=standard STORE_CONSENSUS_REPLICAS=1 STORE_CONSENSUS_PARTITIONS=1 E2T_REPLICAS=2 ./build/bin/smoke-onos-e2t-e2ap101

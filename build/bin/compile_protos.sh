...
protoc -I=$proto_imports --gogofaster_out=Mgoogle/protobuf/duration.proto=github.com/gogo/protobuf/types,Mmodel/model.proto=github.com/onosproject/onos-test/pkg/model,import_path=onos/simulation,plugins=grpc:pkg pkg/simulation/*.proto